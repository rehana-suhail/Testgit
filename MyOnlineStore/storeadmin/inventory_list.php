...
$product_list = "";
$sql = mysqli_query($con,"SELECT * FROM products ORDER BY id");
...
<!-- JavaScript to restrict only the Numeric values in the Price Text Box -->
...
<div align="left" style="margin-left:24px;">
    ...
    <table width="90%" border="0" cellspacing="0" cellpadding="6">
      ...
      <tr>
        ...
        <td><label>
          $
         <input name="price" type="text" id="price" size="12" onkeypress="return isNumberKey(event)"  />
		  <!--<input name="price" id="price" type="number" min="0" step="0.25" value="0.00" pattern="(^\d+(\.|\,)\d{2}$)" />-->
		  <!--<input name="price" type="number" id="price" size="12" onchange="setTwoNumberDecimal" min="0" step="0.25" value="0.00" />
